...
class PasswordKey(object):
    """ This class derives a private key given the account name, the
        role and a password. The password is required to be at least
        20 (10 unique) characters long
    """
    ...
    def __init__(self, account, password, role):
        ...
        if len(password) < 20 or len(set(password)) < 10:
            raise WeakPasswordError(
                "Weak password provided. Should be at least 20 (10 unique) characters long.")
...
class BrainKey(object):
    ...
    @staticmethod
    def suggest():
        """ Suggest a new, 16 word brain key.
        """
        return genphrase(length=16, wordset='bip39')

    @staticmethod
    def normalize(brainkey):
...
class Address(object):
    """ Address class
        ...
        :param str prefix: Network prefix (defaults to ``EOS``)
    ...
    def __init__(self, address=None, pubkey=None, prefix="EOS"):
        self.prefix = prefix
...
class PublicKey(object):
    ...
    def __init__(self, pk, prefix="EOS"):
        self.prefix = prefix
...
class PrivateKey(object):
    ...
    def __init__(self, wif=None, prefix="EOS"):
        if wif is None:
            import os
